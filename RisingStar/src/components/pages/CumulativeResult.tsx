import {
  ...
  import { userCumulativeData} from "../../data";
  import { Doughnut, Bar} from 'react-chartjs-2';
  
  function CumulativeProfile() {
    ...
    const chartData = {
      labels: Object.keys(userCumulativeData.techSkills),
      datasets: [
        {
          label: 'Proficiency',
          data: Object.values(userCumulativeData.techSkills),
          backgroundColor: [
            'rgba(255, 99, 132, 0.2)',
            'rgba(54, 162, 235, 0.2)',
            'rgba(255, 206, 86, 0.2)',
    ...
    const pieData = {
      labels: Object.keys(userCumulativeData.softSkills),
      datasets: [
        {
          label: 'Proficiency',
          data: Object.values(userCumulativeData.softSkills),
          backgroundColor: [
            'rgba(255, 99, 132, 0.2)',
            'rgba(54, 162, 235, 0.2)',
            'rgba(255, 206, 86, 0.2)',
        ...
        <div style={{ width: '100%', paddingTop: '2vh', textAlign: 'center' }}>
          <button 
            ...
            onClick={() => {
              ...
              console.log('Cumulative Result button clicked');
            }}
          >
            Cumulative Result
          </button>
  ...
  export default CumulativeProfile;
